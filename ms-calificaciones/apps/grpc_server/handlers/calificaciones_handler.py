import logging
from apps.concentrado.services import build_concentrado
...
class CalificacionesServicer:
    ...
    def GetConcentrado(self, request, context):
        from apps.grpc_server import calificaciones_pb2
        try:
    ...
    def GetEstadisticasMateria(self, request, context):
        ...
        try:
            ...
            from apps.calificaciones.models import Calificacion as Cal
            alumnos_unicos = Cal.objects.filter(
                actividad_id__in=actividad_ids
