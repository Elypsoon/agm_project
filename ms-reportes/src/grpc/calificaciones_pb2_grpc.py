...
from . import calificaciones_pb2 as calificaciones__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in proto/calificaciones_pb2_grpc.py depends on'
...
class CalificacionesServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetConcentrado = channel.unary_unary(
                ...
                request_serializer=calificaciones__pb2.MateriaIdRequest.SerializeToString,
        ...
        self.GetPromedioAlumno = channel.unary_unary(
                ...
                request_serializer=calificaciones__pb2.AlumnoMateriaRequest.SerializeToString,
        ...
        self.GetEstadisticasMateria = channel.unary_unary(
                ...
                request_serializer=calificaciones__pb2.MateriaIdRequest.SerializeToString,
                response_deserializer=calificaciones__pb2.StatsResponse.FromString,
                _registered_method=True)
...
def add_CalificacionesServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetConcentrado': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=calificaciones__pb2.MateriaIdRequest.FromString,
            ...
            'GetPromedioAlumno': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=calificaciones__pb2.AlumnoMateriaRequest.FromString,
            ...
            'GetEstadisticasMateria': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=calificaciones__pb2.MateriaIdRequest.FromString,
                    response_serializer=calificaciones__pb2.StatsResponse.SerializeToString,
            ),
    }
...
class CalificacionesService(object):
    ...
    def GetConcentrado(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/calificaciones.CalificacionesService/GetConcentrado',
            calificaciones__pb2.MateriaIdRequest.SerializeToString,
    ...
    def GetPromedioAlumno(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/calificaciones.CalificacionesService/GetPromedioAlumno',
            calificaciones__pb2.AlumnoMateriaRequest.SerializeToString,
    ...
    def GetEstadisticasMateria(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            '/calificaciones.CalificacionesService/GetEstadisticasMateria',
            calificaciones__pb2.MateriaIdRequest.SerializeToString,
            calificaciones__pb2.StatsResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
