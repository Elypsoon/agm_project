...
from . import notificaciones_pb2 as notificaciones__pb2
...
class NotificacionesServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SendBienvenida = channel.unary_unary(
                ...
                response_deserializer=notificaciones__pb2.BoolResponse.FromString,
        ...
        self.SendCierreMateria = channel.unary_unary(
                ...
                request_serializer=notificaciones__pb2.CierreRequest.SerializeToString,
                response_deserializer=notificaciones__pb2.BoolResponse.FromString,
                _registered_method=True)
...
def add_NotificacionesServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'SendBienvenida': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=notificaciones__pb2.BoolResponse.SerializeToString,
            ),
            ...
            'SendCierreMateria': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=notificaciones__pb2.CierreRequest.FromString,
                    response_serializer=notificaciones__pb2.BoolResponse.SerializeToString,
            ),
    }
...
class NotificacionesService(object):
    ...
    def SendBienvenida(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            notificaciones__pb2.BoolResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def SendCierreMateria(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/agm.notificaciones.NotificacionesService/SendCierreMateria',
            notificaciones__pb2.CierreRequest.SerializeToString,
            notificaciones__pb2.BoolResponse.FromString,
            options,
            channel_credentials,
            insecure,
